...
#include "Core/Palette/BehaviourPalette.h"
#include "Core/Palette/GraphicsPalette.h"
#include "Core/MasterFile.h"
#include "Core/Palette/FractionsPalette.h"
#include "Core/Palette/ItemsPalette.h"
